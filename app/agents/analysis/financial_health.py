                ...
                class FinancialHealthAgent:
                    ...
                    async def compute_ratios(self, financial_data: dict) -> dict:
                        ...
                        Expected keys in financial_data:
                        - current_assets
                        - current_liabilities
                        - total_debt
                        - total_equity
                        ...
                        if ebit is not None and interest_expense not in (None, 0):
                            ratios["interest_coverage_ratio"] = round(
                    ...
                    async def assess_cash_flow(self, financial_data: dict) -> dict:
                        ...
                        if (
                            ...
                            result["free_cash_flow"] = round(free_cash_flow, 2)

                            if free_cash_flow > 0:
                                result["cash_flow_status"] = "Positive"
                            elif free_cash_flow < 0:
                                result["cash_flow_status"] = "Negative"
                            else:
                                result["cash_flow_status"] = "Neutral"
