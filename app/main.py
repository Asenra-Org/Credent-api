...
from app.routes import documents, analysis, research, reports, history, structured_data, policies, auth, admin, cases, audit, platform
...
app.add_middleware(
    ...
    allow_origins=[
        ...
        "http://127.0.0.1:3000",
        "http://127.0.0.1:5173",
        "https://cresem.asenra.in",
        "https://app.cresem.asenra.in"
    ],
